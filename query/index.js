//var path = require('../../libraries/path');  // REMOVE
//var paths = require('../../paths/paths');    // REMOVE
//var Promise = require(path.join(paths.libraries, '/bluebird.js')); // REMOVE, added as a property
//var util = require(__dirname+'/util.js'); // REMOVE, added as a property
//var Errors = require(__dirname+'/errors.js'); // REMOVE, added as a property
...
Query.prototype.setutility = function(fnOrValue) {
  self._utility = fnOrValue;
}

Query.prototype.feed = function() {
  return self._feed;
}

Query.prototype.setfeed = function(fnOrValue) {
  self._feed = fnOrValue;
}
...
Query.prototype.setpromise = function(fnOrValue) {
